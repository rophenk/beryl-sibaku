...
class ApiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sibankum.admin.apisTable', ['api' => $api, 'user' => $user]);
    }
    ...
    public function create(Request $request)
    {
        ...
        // Tampilkan Form AOI
        return view('sibankum.admin.apisForm', ['server_options' => $server_options, 'user' => $user]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('sibankum.admin.apisFormEdit', ['apis' => $apis, 'server_options' => $server_options, 'user' => $user]);
    }
