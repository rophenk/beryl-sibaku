...
class InstansiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sibankum.admin.instansiTable', ['instansi' => $instansi, 'user' => $user, 'role_id' => $role_id]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('sibankum.admin.instansiForm', ['user' => $user]);
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('sibankum.admin.instansiFormEdit', ['instansi' => $instansi, 'user' => $user]);
    }
