...
use App\Models\Sibankum\ServerModel;
...
class ServerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sibankum.admin.serverTable', ['server' => $server, 'user' => $user, 'role_id' => $role_id]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('sibankum.admin.serverForm', ['instansi_options' => $instansi_options, 'user' => $user]);
    }   
    ...
    public function edit(Request $request)
    {
        ...
        return view('sibankum.admin.serverFormEdit', ['server' => $server, 'instansi_options' => $instansi_options, 'user' => $user]);
    }
