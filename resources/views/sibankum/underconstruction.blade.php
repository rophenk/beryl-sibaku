...
<!-- Mirrored from demo.themeroyal.info/madrin/underconstruction.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Aug 2015 08:45:55 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <body><!--[if lt IE 8]>
    ...
    <div id="ryl-main">
      <header id="home" class="ryl-bg-dots ryl-color-light">
        <div data-stellar-background-ratio="0.25" class="ryl-overlay-bg ryl-home-parallax-background-style-2"></div>
        ...
        <div id="ryl-home-content" class="container ryl-cell-vertical-wrapper">
    ...
    <!--{!! Html::script('sbk/vendors/jquery/jquery-1.11.3.min.js') !!}-->
