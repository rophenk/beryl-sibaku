						...
						<div class="portlet light">
							<div class="portlet-title">
                                ...
                                <div class="actions">
                                    ...
                                    <a class="btn btn-circle btn-icon-only red" href="/case/destroy/{{ $case->uuid }}" onclick="return confirm('Yakin akan menghapus data ini ?')">
									...
									<div class="form-body">
										<div class="form-group">
											...
											<select class="form-control" id="case_type_id" name="case_type_id">
												...
												<?php
													if($case_type->id === $case->case_type_id) {
