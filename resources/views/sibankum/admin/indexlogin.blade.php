...
{!! Html::style('sbk/admin/assets/global/plugins/simple-line-icons/simple-line-icons.min.css') !!}
{!! Html::style('sbk/admin/assets/global/plugins/bootstrap/css/bootstrap.min.css') !!}
{!! Html::style('sbk/admin/assets/global/plugins/uniform/css/uniform.default.css') !!}
<!-- END GLOBAL MANDATORY STYLES -->
<!-- BEGIN PAGE LEVEL STYLES -->

{!! Html::style('sbk/admin/assets/admin/pages/css/login.css') !!}
...
{!! Html::style('sbk/admin/assets/admin/layout/css/layout.css') !!}

{!! Html::style('sbk/admin/assets/admin/layout/css/themes/default.css') !!}
{!! Html::style('sbk/admin/assets/admin/layout/css/custom.css') !!}
<!-- END THEME STYLES -->
...
<div class="logo">
	<a href="/index">
	<img src="{{ asset('sbk/assets/images/logo.png') }}" alt="" width="75px" />
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="indexlogin" method="post">
		{!! csrf_field() !!}
...
<div class="copyright">
	 2017 © Kementerian Pertanian Republik Indonesia.
</div>
<!-- END LOGIN -->
...
{!! Html::script('sbk/admin/assets/global/plugins/jquery-validation/js/jquery.validate.min.js') !!}
{!! Html::script('sbk/admin/assets/global/scripts/metronic.js') !!}
{!! Html::script('sbk/admin/assets/admin/layout/scripts/layout.js') !!}
{!! Html::script('sbk/admin/assets/admin/layout/scripts/demo.js') !!}
{!! Html::script('sbk/admin/assets/admin/pages/scripts/login.js') !!}
<!-- END CORE PLUGINS -->
<!-- END PAGE LEVEL SCRIPTS -->
<script>
